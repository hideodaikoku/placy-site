...
const BlogTemplate = (props) =>{
    ...
    return(
        <Layout color={"white"}>
            ...
            <div className={quarantineBlogStyle.container} style={{display:"flex",justifyContent:"center"}}>
                <a clasName={quarantineBlogStyle.twitter}d href="https://twitter.com/placy_urbanism" target="_blank" rel="noopener noreferrer">
