  ...
  return (
    <div className={memberPageStyle.container}>
      <div className={memberPageStyle.row}>
        <div className={memberPageStyle.left}></div>
        <div className={memberPageStyle.rightContent}>
          <h1 className={memberPageStyle.title}>メンバー紹介</h1>
        </div>
      </div>
      <div className={memberPageStyle.row}>
        <div className={memberPageStyle.leftContent}>
          <div className={memberPageStyle.memberContainer}>
            <Member image={data.soma.childImageSharp} id={"soma"} />
            <Member image={data.kazu.childImageSharp} id={"kazu"} />
            <Member image={data.hideo.childImageSharp} id={"hideo"} />
            <Member image={data.marina.childImageSharp} id={"marina"} />
            <Member image={data.minerva.childImageSharp} id={"minerva"} />
            <Member image={data.miki.childImageSharp} id={"miki"} />
            <Member image={data.stephen.childImageSharp} id={"stephen"} />
            <Member image={data.todd.childImageSharp} id={"todd"} />
            <Member image={data.sp4ghet.childImageSharp} id={"sp4ghet"} />
          </div>
        </div>
