    ...
    <div>
      <div className={positionStyle.container}>
        ...
        <div className={positionStyle.rightContent}>
          <h1 className={positionStyle.sectionTitle}>採用情報</h1>
        </div>
      </div>
            ...
            <div key={position.id} className={positionStyle.position}>
              ...
              <div className={positionStyle.para}>
                ...
                {position.description_sub ? (
                  <ul>
                    <li className={positionStyle.desc_sub}>
                      {position.description_sub}
                    </li>
                  </ul>
                ) : null}
              ...
              <div className={positionStyle.para}>
                <span className={positionStyle.box}>歓迎スキル</span>
                <ul>
                  {position.skills.map((skill, id) => (
                    <div key={id}>
                      <li>{skill.text}</li>
                      <>{skill.sub ? <p>{skill.sub}</p> : null}</>
                    </div>
                  ))}
                </ul>
              </div>
              ...
              <div className={positionStyle.para}>
                <span className={positionStyle.box}>雇用形態</span>
                <p className={positionStyle.desc}>{position.type}</p>
              </div>

              <div className={positionStyle.para}>
                <span className={positionStyle.box}>選考フロー</span>
