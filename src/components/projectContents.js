  ...
  return (
    <div className={projectContentstyles.container}>
      <div className={projectContentstyles.row}>
        <div className={projectContentstyles.pqrContent}>
          ...
          <p className={projectContentstyles.descTop}>
            Cities are the central nodes of our modern economy; hubs of
            creativity and innovation. Our globalised system relies on us living
            collectively, but pandemics are inherently anti-city, as they could
            force the breakdown of collective cooperation. How will our cities
            evolve, to adapt to this new reality?
            <br />
            <br />
            Cities across the world are establishing unique initiatives and
            projects to combat the effects of this situation; and by exploring
            each city's approach, perhaps we can gain a glimpse of our post
            quarantine world.
          </p>
        </div>
        <div className={projectContentstyles.right}>
          <a
            href="https://www.placy.city/post-quarantine-urbanism/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Img
              fluid={data.pqr.childImageSharp.fluid}
              alt={"post quarantine urbanism"}
              className={projectContentstyles.pqr}
            />
          </a>
        </div>
      </div>
        ...
        <div className={projectContentstyles.right}>
          ...
          >
            <Img
              ...
              className={projectContentstyles.imgTop}
            />
            <Img
              fluid={data.pamphlets.childImageSharp.fluid}
              className={projectContentstyles.imgBottom}
            />
          </a>
        </div>
      </div>
      <div className={projectContentstyles.row}>
        ...
        <div className={projectContentstyles.right}>
          <Img
            fluid={data.jr.childImageSharp.fluid}
            className={projectContentstyles.img}
          />
        </div>
      </div>
      <div className={projectContentstyles.kenta}>
        ...
        <div
          className={projectContentstyles.right}
          id={projectContentstyles.green}
        >
